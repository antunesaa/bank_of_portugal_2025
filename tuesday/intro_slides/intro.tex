...
\begin{frame}{Investment}
    ...
    Private AI investment by US firms in 2024 = \$109 billion 

        \vspace{0.5em}
    Estimate for 2025 = \$350 billion
    ...
    \begin{itemize}
        ...
        \vspace{0.5em}
        \item \brown{software development}
    \end{itemize}
...
all_outputs = parallel_function(data_sets)  
    \end{minted}
...
\begin{frame}
    ...
    \begin{figure}
       \centering
       \scalebox{0.14}{\includegraphics{llms0.png}}
    \end{figure}
